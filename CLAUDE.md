...
- **`CLAUDE-DNA-CC.md`** et **`CLAUDE-DNA.md`** — stubs de redirection legacy conservés pour compat ascendante avec d'anciens hooks pointant encore vers l'ancien fichier monolithique.
